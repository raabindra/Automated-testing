...
function getLoginAdmin($data)
{
    ...
    // Parameterized query: user input can never alter the SQL structure (fixes SQLi).
    $stmt = $pdo->prepare("SELECT * FROM employee WHERE email = :email AND password = :password");
